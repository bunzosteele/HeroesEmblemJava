...
public class TutorialUnitFirstScreen extends MenuScreen
{
	Sprite buttonSprite;
	int xOffset;
	int yOffset;
	...
	private void drawContent(){
		...
		final AtlasRegion region = UnitRenderer.UnitSheets.get(UnitType.Footman).findRegion("Idle-0-" + idleFrame);
