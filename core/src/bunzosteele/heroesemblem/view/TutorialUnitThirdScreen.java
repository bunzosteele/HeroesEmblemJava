...
public class TutorialUnitThirdScreen extends ScreenAdapter
{
	HeroesEmblem game;
	Sprite buttonSprite;
	...
	public void draw()
	{
		...
		this.game.font.draw(this.game.batcher, "The knight is fast and strong.", this.xOffset * 3 / 2, this.yOffset * 3, 2 * this.xOffset, 1, true);
		this.game.font.draw(this.game.batcher, "It has the highest defense and movement.", this.xOffset * 3 / 2, this.yOffset * 3 - 1 * this.game.font.getData().lineHeight, 2 * this.xOffset, 1, true);
		this.game.font.draw(this.game.batcher, "Sturdy: Prevents this unit's death, once per battle.", this.xOffset * 3 / 2, this.yOffset * 3 - 5 * this.game.font.getData().lineHeight, this.xOffset * 5 / 2, -1, true);
		this.game.font.draw(this.game.batcher, "Joust: This unit does more damage the further it has moved this turn.", this.xOffset * 3 / 2, this.yOffset * 3 - 7 * this.game.font.getData().lineHeight, this.xOffset * 5 / 2, -1, true);
